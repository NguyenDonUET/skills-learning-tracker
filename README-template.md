# Skills Learning Tracker — [Your Name]
...
<!-- How did you design the dashboard layout? What gets the most visual real estate? How do you represent progress for each skill? -->
...
<!-- How do users log a session? What's the entry point, the input method, and the confirmation? How does it feel? -->
...
<!-- Document any other significant design decisions: navigation structure, heatmap design, streak display, landing page approach, etc. -->
...
| **Data visualization quality** — Progress rings, heatmap, streak indicators, aggregate stats | /5 | |
| **Design-it-yourself features** — Quality and thoughtfulness of dashboard layout and session logging UX | /5 | |
| **Design quality** — Typography, spacing, visual hierarchy, bento grid polish | /5 | |
| **Responsive design** — Fully functional and well-designed across devices | /5 | |
| **Performance** — Fast load, smooth animations, efficient data queries | /5 | |
| **Accessibility** — Keyboard nav, screen reader support, contrast, heatmap alternatives | /5 | |
| **Edge case handling** — Empty states, errors, loading, broken streaks, timezone handling | /5 | |
| **Code quality** — Clean, maintainable, well-structured | /5 | |
| **Landing page** — Compelling, communicates value, visually polished | /5 | |
| **Guest experience** — Immediately impressive, real data, full features | /5 | |
